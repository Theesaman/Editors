...
from .views import index_view, books_view, PortfolioListView, about_view, GalleryListView, BlogListView, ContactFormView, Portfolio_Single_view,BlogDetailView,GalleryDetailView
